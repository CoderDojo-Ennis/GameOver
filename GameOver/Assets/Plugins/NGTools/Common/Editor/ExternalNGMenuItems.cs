...
using NGToolsEditor.NGFullscreenBindings;
...
namespace NGToolsEditor
{
	...
	internal static class ExternalNGMenuItems
	{
		...
		static	ExternalNGMenuItems()
		{
			...
			Utility.AddMenuItemPicker(NGFullscreenBindingsWindow.MenuItemPath + "Edit");
		...
		private static void	OpenNGSyncFolders()
		{
			NGSyncFoldersWindow.Open();
		}

		[MenuItem(NGFullscreenBindingsWindow.RootMenuItemPath + "Edit", priority = Constants.MenuItemPriority + 930)]
		public static void	OpenNGFullScreenBindings()
		{
