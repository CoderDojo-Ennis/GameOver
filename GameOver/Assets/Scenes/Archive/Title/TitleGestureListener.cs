...
public class TitleGestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
    ...
    private static TitleGestureListener instance = null;
    ...
    public static TitleGestureListener Instance
    {
        get
        {
            return instance;
